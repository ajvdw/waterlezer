...
#include "esphome/components/pulse_meter/pulse2_meter_sensor.h"
...
template<typename... Ts> class SetTotalPulsesAction : public Action<Ts...> {
 public:
  SetTotalPulsesAction(Pulse2MeterSensor *pulse_meter) : pulse2_meter_(pulse2_meter) {}
 ...
 protected:
  PulseMeterSensor *pulse2_meter_;
};
